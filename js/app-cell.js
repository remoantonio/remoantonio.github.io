...
$(() => {
    ...
    $('<div>').attr('id', 'str').addClass('attribute').appendTo($('#container')).css('background-color', 'red').attr('droppable','true').on('dragover', false).on('click', dropHome).show()
    $('<div>').attr('id', 'agi').addClass('attribute').appendTo($('#container')).css('background-color', 'green').attr('droppable','true').on('dragover', false).on('click', dropHome).hide()
    $('<div>').attr('id', 'int').addClass('attribute').appendTo($('#container')).css('background-color', 'blue').attr('droppable','true').on('dragover', false).on('click', dropHome).hide()
